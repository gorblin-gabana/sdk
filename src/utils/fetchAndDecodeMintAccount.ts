import type { DecodedMintAccount } from "../utils/decodeMintAccount.js";
import { decodeMintAccount } from "../utils/decodeMintAccount.js";
...
export async function fetchAndDecodeMintAccount(
  mint: string,
