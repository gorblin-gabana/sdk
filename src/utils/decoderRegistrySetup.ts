...
export function createDecoderRegistry(
  ...
  registry.register(
    "system",
    systemProgramId,
    (instruction: InternalRawInstruction): DecodedInstruction => {
  ...
  registry.register(
    "spl-token",
    splTokenProgramId,
    (instruction: any): DecodedInstruction => {
  ...
  const ataProgramId =
    config.programIds?.ata || "4YpYoLVTQ8bxcne9GneN85RUXeN7pqGTwgPcY71ZL5gX";
  registry.register(
    "ata",
    ataProgramId,
    (instruction: any): DecodedInstruction => {
