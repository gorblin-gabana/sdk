...
import { mplCore, createV1, ruleSet } from '@metaplex-foundation/mpl-core';
...
function validateNFTParameters(params: NFTCreationParams): void {
  ...
  if (params.royaltyBasisPoints && (params.royaltyBasisPoints < 0 || params.royaltyBasisPoints > 10000)) {
...
export async function createToken22TwoTx(
  ...
  if (params.uri) {
    ...
    const additionalRent = await connection.getMinimumBalanceForRentExemption(newSize) - accountInfo.lamports;
