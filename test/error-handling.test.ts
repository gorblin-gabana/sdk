...
import { DecoderNotFoundError } from "../src/errors/decoder";
import { TransactionNotFoundError } from "../src/errors/transaction";
import { InvalidAddressError } from "../src/errors/validation";
import {
  retry,
  RetryManager,
  CircuitBreaker,
...
describe("Error Handling System", () => {
  describe("Base Error Classes", () => {
    ...
    it("should convert error to JSON", () => {
      const error = new RpcNetworkError("Network error", {
    ...
    it("should get detailed error message", () => {
      const error = new RpcTimeoutError(30000, {
        rpcEndpoint: "https://rpc.gorbchain.xyz",
  ...
  describe("Specific Error Types", () => {
    it("should create RPC errors with correct properties", () => {
      const serverError = new RpcServerError("Server error", 500, -32603, {
        rpcEndpoint: "https://rpc.gorbchain.xyz",
      });
    ...
    it("should create decoder errors with correct properties", () => {
      const decoderError = new DecoderNotFoundError("test-program-id", {
    ...
    it("should create transaction errors with correct properties", () => {
      const txError = new TransactionNotFoundError("test-signature", {
        transactionSignature: "test-signature",
      });
