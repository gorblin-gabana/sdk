...
async function main() {
  ...
  console.log('Encrypted:', personalEncrypted.encryptedData.substring(0, 50) + '...');
  ...
  console.log('Encrypted by Alice for Bob:', directEncrypted.encryptedData.substring(0, 50) + '...');
  ...
  // Alice sends message
  const channelMsg1 = await aliceChannel.encryptMessage('Hello Bob! How are you?');
  ...
  // Bob responds
  const channelMsg2 = await bobChannel.encryptMessage('Hi Alice! I\'m doing great!');
  const aliceReceived2 = await aliceChannel.decryptMessage(channelMsg2);
  console.log('Bob -> Alice:', new TextDecoder().decode(aliceReceived2.message));
  console.log();
  ...
  console.log('Encrypted for group:', groupEncrypted.encryptedData.substring(0, 50) + '...');
