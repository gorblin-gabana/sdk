...
async function runAllExamples() {
  ...
  console.log("");
  console.log(
    "This demonstration showcases the key capabilities of GorbchainSDK V1:",
  );
  ...
  console.log("");
  console.log(
    "Perfect for building DeFi apps, NFT marketplaces, and portfolio trackers!",
  );
  console.log("");
  console.log("=".repeat(60));
  console.log("");
  ...
  const examples = [
    ...
    {
      name: "Transaction Analysis & Decoding",
      fn: richTransactionAnalysisExample,
    },
