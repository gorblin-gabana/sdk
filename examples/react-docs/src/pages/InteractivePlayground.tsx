...
const testCategories = {
  ...
  "Rich Token Operations": [
    {
      ...
      description:
        "Get comprehensive token portfolio with metadata and insights",
      ...
      example:
        "await sdk.getRichTokenAccounts(address, { includeMetadata: true, includeNFTs: true })",
    },
    {
  ...
  "Rich Transaction Operations": [
    {
      ...
      description:
        "Get enhanced transaction data with decoded instructions and token metadata",
      ...
      example:
        "await sdk.getRichTransaction(signature, { includeTokenMetadata: true, includeBalanceChanges: true })",
    },
    {
  ...
  "Universal Wallet Integration": [
    ...
    },
    {
      ...
      example:
        "await walletManager.discoverWallets({ includeExtensions: true })",
  ...
  "SDK Information": [
    {
      ...
      description:
        "List all supported blockchain programs in the decoder registry",
  ...
  const initializeSDK = async () => {
    try {
      ...
      try {
        ...
        console.log(
          "⚠️ Wallet manager creation skipped (expected in Node.js environment)",
        );
      }
    ...
    try {
      ...
      const params =
        test.params
          ?.map((param: any) => {
            const value =
              paramValues[`${testId}_${param.name}`] || param.placeholder;
      ...
      switch (test.method) {
        ...
        case "getRichTransaction":
          const [signature, includeTokenMetadata, includeBalanceChanges] =
            params;
        ...
        case "createWalletManager":
          if (!walletManager) {
            result = {
              error: "Wallet manager not available in this environment",
            };
          } else {
        ...
        case "discoverWallets":
          if (!walletManager) {
            result = {
              error:
                "Wallet manager required. Not available in Node.js environment.",
            };
          } else {
      ...
      const errorResult = {
        ...
        note: test.method.includes("Rich")
          ? "This is expected when running with example data"
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6">
        ...
        <div className="bg-white rounded-lg p-4 border border-green-200">
          ...
          <div className="mt-2 text-sm text-gray-600">
            🚀 Ready for rich functions: Enhanced token analysis • Rich
            transaction decoding • Universal wallet integration • Portfolio
                ...
                >
                        ...
                        {test.params.map((param: any) => (
                          ...
                          >
                            ...
                            {param.type === "boolean" ? (
                              <select
                                value={
                                  paramValues[`${test.id}_${param.name}`] ||
                                  param.placeholder
                                }
                                onChange={(e) =>
                                  updateParam(
                  ...
                  {test.requiresWalletManager && (
                    <div className="mb-3 p-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800">
                      💡 This function requires wallet manager and works best in
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <ul className="space-y-1 text-gray-600">
              ...
              <li>
                • Use real transaction signatures for transaction analysis
              </li>
