  ...
  "Scalable Encryption": [
    {
      ...
      description:
        "Create encryption context that scales from 1 to N recipients",
...
const { manager, context } = await createScalableEncryption(
  ...
  { autoTransitionThreshold: 3 }
    ...
    },
    {
      ...
      description:
        "Encrypt data within a scalable context (auto-scales method)",
...
function KeyGenerationHelper({
  ...
  return (
    <div className="mb-6 docs-card bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
      <h3 className="text-lg font-bold text-docs-heading mb-2">
        🔑 Test Keys Generator
      </h3>
      <p className="text-sm text-gray-600 mb-5">
        Generate test keypairs for crypto operations. These are for testing
      ...
      {generatedKeys.length > 0 && (
        <div className="space-y-4">
          <p className="text-sm font-semibold text-docs-heading mb-2">
            Generated Keys{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {generatedKeys.map((key, index) => (
              <div
                key={index}
                className="docs-card bg-white border border-gray-100 rounded-2xl p-4 flex flex-col gap-2 shadow-sm"
              >
                  ...
                  <span
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " ")
                        handleCopy(key.publicKey, `pub-${index}`);
                    }}
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " ")
                        handleCopy(key.privateKey, `priv-${index}`);
                    }}
                  >
                    {copied[`priv-${index}`]
                      ? "Copied!"
                      : key.privateKey.substring(0, 20) + "..."}
                  </span>
                </div>
              </div>
            ))}
    ...
    <div className="max-w-7xl mx-auto p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Interactive testing environment for GorbchainSDK encryption and
          decryption features
        </p>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-800 mb-2">
              This playground runs in demo mode with simulated encryption for
              browser compatibility. All cryptographic operations are
              educational examples only.
            </p>
            <div className="text-xs text-yellow-700">
              <p>
                ✅ <strong>Working features:</strong> Key generation,
                encryption/decryption simulation, signature demo
              </p>
              <p>
                🔒 <strong>Production use:</strong> Install the full SDK for
        ...
        <div className="xl:col-span-2">
          <div className="docs-card bg-white rounded-2xl border border-gray-200 overflow-hidden sticky top-4 shadow-sm">
            <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-6 rounded-2xl">
              <h2 className="text-xl font-bold mb-2">🔐 Crypto Methods</h2>
              <p className="text-emerald-100 text-sm">
                Choose a cryptographic operation to test
              </p>
            </div>
            <div className="p-6 max-h-96 overflow-y-auto">
              {Object.entries(cryptoTestCategories).map(
                ([category, methods]) => (
          ...
          {selectedMethodData ? (
            ...
            <div className="docs-card bg-white rounded-lg border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-600 mb-6 text-lg max-w-2xl mx-auto">
                Select a cryptographic method from the sidebar to start
                exploring encryption, decryption, and digital signatures.
              </p>
