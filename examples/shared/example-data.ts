...
export const EXAMPLE_TRANSACTIONS = {
  ...
  defiSwap: {
    signature: '2h6r3G7m8NqfA1mO7xU2pD4Q8K6nL1sJ5tX0vH8oN2wP7eQ4tX0vH8oN2wP7eQ4tX',
...
export function handleExampleError(error: unknown, context: string): void {
  console.log(`❌ ${context} failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
